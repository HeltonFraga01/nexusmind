...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeCiabra:    {"publickey": {}, "secretkey": {}, "webhooksecret": {}},
}
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeCiabra:    {"publickey": {}, "secretkey": {}, "webhooksecret": {}, "apibase": {}, "paymenttypes": {}, "duedays": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true, payment.TypeCiabra: true,
}
