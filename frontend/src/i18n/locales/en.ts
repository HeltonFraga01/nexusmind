export default {
  ...
  home: {
    ...
    // Route-Cortexx New Home Page
    title: 'Route-Cortexx | Intelligent API Distribution',
    explorePackages: 'Explore Packages',
    routeYourApi: 'Route Your API Through Cortexx',
    distributeAndManage: 'Distribute, manage, and monetize your AI API quota with precision. Route requests intelligently across multiple providers with one unified gateway.',
    powerfulFeatures: 'Powerful Features',
    featuresSubtitle: 'Everything you need to manage API quotas at scale',
    unifiedGateway: 'Unified Gateway',
    unifiedGatewayDesc: 'Route requests to any AI provider through a single, unified API endpoint',
    smartDistribution: 'Smart Distribution',
    smartDistributionDesc: 'Intelligently distribute requests across accounts with sticky sessions and failover',
    realtimeAnalytics: 'Real-time Analytics',
    realtimeAnalyticsDesc: 'Track usage, costs, and quotas in real-time with detailed billing breakdowns',
    chooseYourPlan: 'Choose Your Plan',
    flexiblePackages: 'Flexible packages tailored to your needs',
    supportedProviders: 'Supported Providers',
    connectWithFavorite: 'Connect with your favorite AI providers',
    // Empty state for no plans
    noPlansDraft: 'Ready to Build?',
    noPlansDescription: 'No subscription plans created yet. Start by adding your first package to begin offering services to your users.',
    createFirstPlan: 'Create First Plan',
    tipsTitle: '💡 Quick Tips',
    tip1: 'Packages define your service offerings and pricing',
    tip2: 'Each plan can support multiple AI providers',
    tip3: 'Set custom rate limits and usage quotas',
    footer: {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_ciabraApiBaseHint: 'Use the AZ Center invoices base URL. Default: https://api.az.center/invoices.',
        ...
        ciabraGuideNote: 'Use BRL for Ciabra invoice currency unless your AZ Center contract explicitly supports additional currencies. Keep webhook secret and header names synchronized between Sub2API and AZ Center.',
        limitsTitle: 'Limits',
