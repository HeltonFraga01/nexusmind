...
export const METHOD_ORDER = ['alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex', 'ciabra'] as const
...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  ciabra: '/api/v1/payment/webhook/ciabra',
}
...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  // ciabra: 不需要回调 URL 配置，Webhook 在 Ciabra/AZ Center 后台配置。
}
