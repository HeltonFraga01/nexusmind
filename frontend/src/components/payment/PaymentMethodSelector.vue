...
const METHOD_ICONS: Record<string, string> = {
  ...
  ciabra: airwallexIcon, // nexusmind
}
...
function methodIcon(type: string): string {
  ...
  if (type === 'ciabra') return METHOD_ICONS.ciabra // nexusmind
...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'ciabra') return 'border-[#3B82F6] bg-sky-50 text-gray-900 shadow-sm dark:border-[#60A5FA] dark:bg-sky-950 dark:text-gray-100' // nexusmind
