...
export type PaymentType = 'alipay' | 'wxpay' | 'alipay_direct' | 'wxpay_direct' | 'stripe' | 'easypay' | 'airwallex' | 'ciabra'
...
export interface CreateOrderRequest {
  ...
  is_mobile?: boolean
  /** CPF/CNPJ when the selected provider needs it (e.g. Ciabra). */
